...
Thank you for considering contributing to GYM GUIDE! Please take a moment to review the guidelines below before making a contribution.
...
4. Add upstream command to your fork (e.g. `git remote add upstream https://github.com/Pranjal-Agrawal1402/GYM-GUIDE`)
...
GYM GUIDE is licensed under the MIT License. By contributing to this repository, you agree to license your contributions under the same license.
...
Thank you for contributing to GYM GUIDE! 🏋️‍♀️🏋️‍♂️
